...
func init() {
	registerCustomChecks("pdbMinAvailableLessThanHPAMaxReplicas", pdbMinAvailableLessThanHPAMaxReplicas)
}

func pdbMinAvailableLessThanHPAMaxReplicas(test schemaTestCase) (bool, []jsonschema.ValError, error) {
